...
class EsMonitorCallback extends ConsumerCallback
{
    /**
    ...
    private function alarm($msgs)
    {
        Coroutine::create(function () use ($msgs) {
            ...
            $this->stdOutLogger->info('universal es callback msg:' . json_encode($msgs));
            ...
            $this->stdOutLogger->info('universal es alarm condition:' . json_encode($alarmCondition));
