...
use App\Consumer\MonitorCallback\Cycle\CycleEsMonitorCallback;
...
class CycleEsDataSource extends BDataSource implements IDataSource
{
...
//                      $dataFormat = 'epoch_millis';
                    ...
                    case 4:
                        ...
                        $end = strtotime($end);
                        $dataFormat = 'date_hour_minute_second';
                        break;
                }
...
//                "format":"epoch_millis"
                ...
                $params['body']['aggs']['my_id_stats']['stats']['field'] = 'my_id';
                $params['body']['from'] = 0;
                //size 0 聚合仍然生效，只是不返回数据
                $params['body']['size'] = 0;
                $params['body']['sort'][$timestampField] = 'asc';
                ...
                $this->stdOutLogger->info('es query result ' . json_encode($ret));
                $this->stdOutLogger->info('es alarm conditions ' . json_encode($alarmConditionArr));
    ...
    {
        /** @var CycleEsMonitorCallback $callback */
        $callback = make(CycleEsMonitorCallback::class);
        $rc = new \ReflectionClass(CycleEsMonitorCallback::class);
