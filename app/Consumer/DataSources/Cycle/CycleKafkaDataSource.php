...
use App\Consumer\MonitorCallback\Cycle\CycleKafkaMonitorCallback;
use Hyperf\Utils\Coroutine;
use XesMq\Mq\Consumer;

class CycleKafkaDataSource extends Consumer implements IDataSource
{
...
//        //（`kafka没有消息的时候fetch要等待的时间）
        ...
        /** @var CycleKafkaMonitorCallback $callback */
        $callback = make(CycleKafkaMonitorCallback::class);
        $rc = new \ReflectionClass(CycleKafkaMonitorCallback::class);
